  ...
  //<![CDATA[
    ...
    function payment(agent){
        ...
        request.done(function( data ) {
            if(agent === 'web'){
                //windowReference.location = 'http://localhost:8090/khbook/kakaocashinfo.kh';
                location.href = 'http://localhost:8090/khbook/kakaocashinfo.kh';
            	//$(location).attr('href', 'http://localhost:8090/khbook/kakaocashinfo.kh');
            } else {
