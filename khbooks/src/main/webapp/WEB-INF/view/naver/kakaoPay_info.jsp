...
<script>
        var hash = "http://localhost:8090/khbook/kakaocashinfo2.kh";
        var failUrl = "https://developers.kakao.com/payment/web/fail/4e6b62c4-387c-4411-9041-5ab57f10b6d0";
        var remainingSec = 899;
        var cancelUrl = "https://developers.kakao.com/payment/web/cancel/4e6b62c4-387c-4411-9041-5ab57f10b6d0";
...
<div class="kakaopay_layer">
		<div class="inner_kakaopay">
			...
			<div class="layer_body">
				...
				<form id="userPost" method="post" action="http://localhost:8090/khbook/kakaocashinfo2.kh" >
					<fieldset>
